...
echo "<user-mapping>
  <authorize username=\"guacadmin\" password=\"${admin_password}\">
    <connection name=\"aws-${aws_r1_location_short}-${application_1}\">
      <protocol>ssh</protocol>
      <param name=\"hostname\">${hostname_r1_app1}</param>
      <param name=\"username\">ubuntu</param>
      <param name=\"password\">${admin_password}</param>
    </connection>
    <connection name=\"aws-${aws_r1_location_short}-${application_2}\">
      <protocol>ssh</protocol>
      <param name=\"hostname\">${hostname_r1_app2}</param>
      <param name=\"username\">ubuntu</param>
      <param name=\"password\">${admin_password}</param>
    </connection>
    <connection name=\"aws-${aws_r2_location_short}-${application_1}\">
      <protocol>ssh</protocol>
